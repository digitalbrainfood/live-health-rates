      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          <p className="text-gray-700 leading-relaxed">
            Thank you for choosing to be part of our community at Rising Health Insurance Agency FL LLC, doing business as Health Coverage Search (&ldquo;Health Coverage Search&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at <a href="mailto:contact@healthcoveragesearch.com" className="text-blue-600 hover:underline">contact@healthcoveragesearch.com</a>.
          </p>
          <p className="text-gray-700 leading-relaxed">
