      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4 uppercase font-medium">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              If you have any questions or concerns regarding our privacy policy please direct them to: <a href="mailto:info@livehealthrates.com" className="text-blue-600 hover:underline">info@livehealthrates.com</a>
            </p>
          </section>
        </div>
